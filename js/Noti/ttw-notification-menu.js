     ...
     $.ttwNotificationMenu = function(userOptions) {
        ...
        Notification.prototype.create = function() {
            ...
            if (this.settings.message) {
                ...
                idR = getReporteID(this.settings.message)+'';
                //this.message = '<a onclick="sendToReporte("'+idR+'");">'+this.settings.message+'</a>';
                this.message = '<a href="/msicdi/soporte/rastreo?codigo='+idR+'">'+this.settings.message+'</a>';
