...
$layout = new TLayout("export", "DeliciousOffice", "MobileOffice");
$layout->version = 2;
...
$page_layouts["reportesaio_export"] = $layout;
...
if( @$_REQUEST["a"] != "" )
{
	...
	if (@$_REQUEST["mdelete"])
	{
		...
		{
			$keys=array();
			$keys["num"] = refine($_REQUEST["mdelete1"][mdeleteIndex($ind)]);
			$selected_recs[] = $keys;
		}
	}
