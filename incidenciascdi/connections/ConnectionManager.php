...
class ConnectionManager
{
	...
	{
		return $this->byId( "cdi_imss_at_11_1_21_5" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "cdi_imss_at_11_1_21_5";
		$data["connName"] = "cdi_imss at 11.1.21.5";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;11.1.21.5;root;admin;;cdi_imss;;1"; //currently unused
		
		$this->_connectionsIdByName["cdi_imss at 11.1.21.5"] = "cdi_imss_at_11_1_21_5";
		...
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "cdi_imss";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=11.1.21.5;Uid=root;Pwd=admin;Database=cdi_imss;OPTION=3";
		$connectionsData["cdi_imss_at_11_1_21_5"] = $data;
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["win10"] = "cdi_imss_at_11_1_21_5";
		$connectionsIds["unidad"] = "cdi_imss_at_11_1_21_5";
		$connectionsIds["reportesaio"] = "cdi_imss_at_11_1_21_5";
