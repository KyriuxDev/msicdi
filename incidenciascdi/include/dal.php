...
class tDAL
{
	var $tblcdi_imss_at_11_1_21_5__reportesaio;
	var $tblcdi_imss_at_11_1_21_5__unidad;
	var $tblcdi_imss_at_11_1_21_5__win10;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "reportesaio", "varname" => "cdi_imss_at_11_1_21_5__reportesaio", "altvarname" => "reportesaio", "connId" => "cdi_imss_at_11_1_21_5", "schema" => "", "connName" => "cdi_imss at 11.1.21.5");
		$this->lstTables[] = array("name" => "unidad", "varname" => "cdi_imss_at_11_1_21_5__unidad", "altvarname" => "unidad", "connId" => "cdi_imss_at_11_1_21_5", "schema" => "", "connName" => "cdi_imss at 11.1.21.5");
		$this->lstTables[] = array("name" => "win10", "varname" => "cdi_imss_at_11_1_21_5__win10", "altvarname" => "win10", "connId" => "cdi_imss_at_11_1_21_5", "schema" => "", "connName" => "cdi_imss at 11.1.21.5");
	}
