...
class tDAL
{
	var $tblcedulas_at_11_1_21_5__cat_adscripcion;
	var $tblcedulas_at_11_1_21_5__cat_criterios;
	var $tblcedulas_at_11_1_21_5__cat_personal;
	var $tblcedulas_at_11_1_21_5__datos;
	var $tblcedulas_at_11_1_21_5__respuestas;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "cat_adscripcion", "varname" => "cedulas_at_11_1_21_5__cat_adscripcion", "altvarname" => "cat_adscripcion", "connId" => "cedulas_at_11_1_21_5", "schema" => "", "connName" => "cedulas at 11.1.21.5");
		$this->lstTables[] = array("name" => "cat_criterios", "varname" => "cedulas_at_11_1_21_5__cat_criterios", "altvarname" => "cat_criterios", "connId" => "cedulas_at_11_1_21_5", "schema" => "", "connName" => "cedulas at 11.1.21.5");
		$this->lstTables[] = array("name" => "cat_personal", "varname" => "cedulas_at_11_1_21_5__cat_personal", "altvarname" => "cat_personal", "connId" => "cedulas_at_11_1_21_5", "schema" => "", "connName" => "cedulas at 11.1.21.5");
		$this->lstTables[] = array("name" => "datos", "varname" => "cedulas_at_11_1_21_5__datos", "altvarname" => "datos", "connId" => "cedulas_at_11_1_21_5", "schema" => "", "connName" => "cedulas at 11.1.21.5");
		$this->lstTables[] = array("name" => "respuestas", "varname" => "cedulas_at_11_1_21_5__respuestas", "altvarname" => "respuestas", "connId" => "cedulas_at_11_1_21_5", "schema" => "", "connName" => "cedulas at 11.1.21.5");
	}
