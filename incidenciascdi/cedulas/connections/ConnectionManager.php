...
class ConnectionManager
{
	...
	{
		return $this->byId( "cedulas_at_11_1_21_5" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "cedulas_at_11_1_21_5";
		$data["connName"] = "cedulas at 11.1.21.5";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;11.1.21.5;admin;admin;;cedulas;;1"; //currently unused
		
		$this->_connectionsIdByName["cedulas at 11.1.21.5"] = "cedulas_at_11_1_21_5";
		...
		$data["connInfo"][0] = "11.1.21.5";
		$data["connInfo"][1] = "admin";
		$data["connInfo"][2] = "admin";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "cedulas";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=11.1.21.5;Uid=admin;Pwd=admin;Database=cedulas;OPTION=3";
		$connectionsData["cedulas_at_11_1_21_5"] = $data;
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["cat_adscripcion"] = "cedulas_at_11_1_21_5";
		$connectionsIds["cat_criterios"] = "cedulas_at_11_1_21_5";
		$connectionsIds["cat_personal"] = "cedulas_at_11_1_21_5";
		$connectionsIds["datos"] = "cedulas_at_11_1_21_5";
		$connectionsIds["respuestas"] = "cedulas_at_11_1_21_5";
