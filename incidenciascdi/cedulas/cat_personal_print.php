...
$page_layouts["cat_personal_print"] = $layout;
...
$page_layouts["datos_masterprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "cat_personal" );
