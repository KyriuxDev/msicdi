...
require_once("include/cat_criterios_variables.php");
...
$page_layouts["cat_criterios_print"] = $layout;
...
$layout->blocks["top"][] = "master";
$page_layouts["respuestas_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "cat_criterios" );
