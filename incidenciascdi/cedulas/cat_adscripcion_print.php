...
require_once("include/cat_adscripcion_variables.php");
...
$page_layouts["cat_adscripcion_print"] = $layout;
...
$layout->blocks["top"][] = "master";
$page_layouts["datos_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "cat_adscripcion" );
