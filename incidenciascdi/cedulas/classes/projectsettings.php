...
function GetTableURL($table = "")
{
	...
	if(!$table)
		$table=$strTableName;
	if("cat_adscripcion" == $table) 
		return "cat_adscripcion";
	if("cat_criterios" == $table) 
		return "cat_criterios";
	if("cat_personal" == $table) 
		return "cat_personal";
	if("datos" == $table) 
		return "datos";
	if("respuestas" == $table) 
...
{	
	...
	if(!$shortTName)
		return false;
	if("cat_adscripcion" == $shortTName) 
		return "cat_adscripcion";
	if("cat_criterios" == $shortTName) 
		return "cat_criterios";
	if("cat_personal" == $shortTName) 
		return "cat_personal";
	if("datos" == $shortTName) 
		return "datos";
	if("respuestas" == $shortTName) 
		return "respuestas";
}
