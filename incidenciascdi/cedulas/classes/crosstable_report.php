...
class CrossTableReport
{
	...
	public function isProjectDB()
	{
		...
		$isDB = false;
		if("cat_adscripcion" == $this->xml_array['tables'][0])
			$isDB = true;
		if("cat_criterios" == $this->xml_array['tables'][0])
			$isDB = true;
		if("cat_personal" == $this->xml_array['tables'][0])
			$isDB = true;
		if("datos" == $this->xml_array['tables'][0])
			$isDB = true;
		if("respuestas" == $this->xml_array['tables'][0])
			$isDB = true;
		return $isDB;
	}
