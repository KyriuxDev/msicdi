...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("cat_adscripcion" == $this->chrt_array['tables'][0])
			return true;
		if("cat_criterios" == $this->chrt_array['tables'][0])
			return true;
		if("cat_personal" == $this->chrt_array['tables'][0])
			return true;
		if("datos" == $this->chrt_array['tables'][0])
			return true;
		if("respuestas" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
