...
$layout = new TLayout("print", "DeliciousOffice", "MobileOffice");
$layout->version = 2;
...
$page_layouts["reportesaio_print"] = $layout;
...
$layout = new TLayout("masterprint", "DeliciousOffice", "MobileOffice");
$layout->version = 2;
...
$page_layouts["unidad_masterprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "reportesaio" );
