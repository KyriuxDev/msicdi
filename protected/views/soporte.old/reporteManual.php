			...
			<div id="form-block">
				...
				<div id="div-form-inside">
					<div class="form-group">
					    ...
					    <input type="text" class="form-control" name="ntel" id="ntel"  placeholder="Escriba su teléfono de oficina">
			  		</div>
				</div>
				<div id="div-form-inside">
					<div class="form-group">
					    <label for="nserie"><font color="green">Usuario de Windows:</font></label>
					    <input type="text" class="form-control" name="nUsuar" id="nUsuar"  placeholder="Escriba el usuario que se muestra al encender el equipo">
			  		</div>
				</div>
				<div id="div-form-inside">
					<div class="form-group">
					    <label for="nserie"><font color="green">Contraseña de usuario:</font></label>
					    <input type="text" class="form-control" name="nContra" id="nContra"  placeholder="Escriba la contraseña que escribe al encender el equipo">
			  		</div>
				</div>
				<div id="div-form-inside">
					<div class="form-group">
					    <label for="nserie"><font color="green">Ip del Equipo:</font></label>
					    <input type="text" class="form-control" name="nIpEquipo" id="nIpEquipo"  placeholder="Escriba la dirección ip del equipo que esta reportando">
			  		</div>
				</div>
			</div>
			<div id="div-form-inside">
