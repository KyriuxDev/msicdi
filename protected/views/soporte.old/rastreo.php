	...
	<table class="table">
		<tbody>
			<tr>
				...
				<td>
					<h5>NNI/N. Serie: <?php echo ($dat[0]['nSerie']); ?></h5>
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				<td>
					<h5>Telefono: <?php echo $dat[0]['Telefono']; ?></h5>
				</td>
				<td>
				</td>
			</tr>
...
<?//php if ( $isAdmin || ($isMine  && ( $dat[0]['status']=='Nuevo' || $dat[0]['status']=='Proceso' || $dat[0]['status']=='Espera' )) ): ?>
	<div id="rastreo-respuesta">
            ...
            <a class="btn btn-warning" href="<?php echo '/msicdi/report/reporte?idTicket='.$codigo; ?>" target="_blank">Generar Reporte</a>
            <button class="btn btn-primary" type="submmit">Actualizar</button>
	</div>
<?php //endif ?>
