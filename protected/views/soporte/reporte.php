...
<div id="div-form">
		<form role="form"   id="reporteForm" name="reporteForm" action="<?php echo Yii::app()->request->baseUrl; ?>/soporte/ReporteEnviado" onsubmit="return <?php echo $tipoForm; ?>" method="post">
			...
			<div id="form-block">
				<div id="div-form-inside">
					<div class="form-group">
					    <label for="nserie">Número de Serie / NNI:</label>
			...
			<div id="form-block">
				<div id="div-form-inside">
					<div class="form-group">
					    <label for="falla">Descripción De Falla:</label>
			...
			<table>
				<tbody>
					<tr>
						...
						<td>
						<li class="smaller">
							Todos los reportes son controlados mediante la dirección ip de origen, por lo que cualquier reporte invalido repercutira
							en proximos reportes y serán candidatos a las sanciones establecidas por la coordinación de informática.
						</li>
						</td>
					</tr>
				</tbody>
